...
// GetDefaultAgentPoolSpec mocks base method.
func (m *MockManagedClusterScope) GetDefaultAgentPoolSpec() azure.AgentPoolSpec {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetDefaultAgentPoolSpec")
	ret0, _ := ret[0].(azure.AgentPoolSpec)
	return ret0
}

// GetDefaultAgentPoolSpec indicates an expected call of GetDefaultAgentPoolSpec.
func (mr *MockManagedClusterScopeMockRecorder) GetDefaultAgentPoolSpec() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetDefaultAgentPoolSpec", reflect.TypeOf((*MockManagedClusterScope)(nil).GetDefaultAgentPoolSpec))
}
